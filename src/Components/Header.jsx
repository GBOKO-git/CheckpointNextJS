  ...
  return (
    <header className=" bg-blue-400/40 fixed top-0 w-full z-50 shadow-lg">
      ...
      {menuOpen && (
        ...
        <ul className="absolute top-full right-0 md:w-1/5 h-62 bg-white/30 backdrop-blur-md text-blue-950 px-4 py-2 flex flex-col items-end gap-4 md:hidden shadow-lg z-40 border-l border-white/20">
